# -*- coding: utf-8 -*-
"""
Created on Tue Dec 20 18:47:10 2016
...
class OpenRanking(wx.Frame):
  
    def __init__(self, parent):
        super(OpenRanking, self).__init__(parent, size=(390, 350))
            
        self.InitUI()
        self.Centre()
        self.Show()
        self.SetTitle('Abrir Ranking')
    ...
    def InitUI(self):
        ...
        btn1 = wx.Button(panel, label='Abrir', size=(70, 30))
        hbox5.Add(btn1)
        ...
        btn1.Bind(wx.EVT_BUTTON, self.abrir)
